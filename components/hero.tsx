...
export default function HeroGeometric({
  badge = "FRAME YOUR LIFE",
  title1 = "PHOTOGRAPHY LAB",
  title2 = "IHEC CARTHAGE",
}: {
  badge?: string;
  title1?: string;
  title2?: string;
    ...
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-[#030303]">
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            <Image
              src="https://img.icons8.com/color/48/old-time-camera.png"
              alt="Kokonut UI"
              width={20}
              height={20}
            />
          ...
          >
            <h1 className="mb-6 text-4xl font-bold tracking-tight sm:text-6xl md:mb-8 md:text-8xl">
              ...
              <span
                className={cn(
                  "bg-gradient-to-r from-stone-300 via-red-400/90 to-white bg-clip-text text-transparent ",
                  pacifico.className
                )}
              >
                {title2}
          ...
          >
            <p className="mx-auto mb-8 max-w-xl px-4 text-base font-light leading-relaxed tracking-wide text-white/40 sm:text-lg md:text-xl">
              Capturing moments, creating memories, and inspiring through the lens.
            </p>
          </motion.div>
        </div>
      </div>
