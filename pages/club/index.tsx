    ...
    <Layout>
        ...
        >
          ...
          <p className="mb-8 max-w-3xl text-xl sm:text-2xl md:text-3xl">
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="rounded-full bg-white bg-opacity-20 backdrop-blur-lg px-6 py-3 text-lg font-semibold text-white shadow-lg"
              href="#clubs"
              onClick={(e) => {
              e.preventDefault();
      ...
      <section id="clubs" className="bg-black px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <h2 className="mb-8 text-center text-3xl font-bold text-white">Our Clubs</h2>
