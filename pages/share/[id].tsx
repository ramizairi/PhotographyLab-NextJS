...
const ShareImagePage = () => {
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          ...
          text:
            image.description ||
            "Check out this amazing image from Photography Lab!",
  ...
  const handleTwitterShare = () => {
    const text = `Check out this amazing photo: ${
      image.title || "Photography Lab Image"
    }`;
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:title"
          content={image.title || "Photography Lab Image"}
        />
        <meta
          property="og:description"
          content={
            image.description ||
            "Check out this amazing photography from Photography Lab!"
          }
        />
      ...
      <div className="relative flex min-h-screen flex-col bg-gray-900">
        ...
        {notification && (
          <div
            className={`fixed left-1/2 top-4 z-50 -translate-x-1/2 transform rounded-lg px-4 py-2 text-white shadow-lg ${
        ...
        <div
          className={`absolute left-0 right-0 top-0 z-10 bg-gradient-to-b from-black/70 to-transparent p-4 transition-opacity duration-300 ${
